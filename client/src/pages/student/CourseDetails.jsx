...
          <h1 className='md:text-course-details-large text-course-details-small font-semibold text-gray-800'>{courseData.courseTitle}</h1>
...
                  <p className='text-sm'>Course by <span classname='text-blue-600 underline'>Chethana</span></p>
...
                  <button className='md:mt-6 mt-4 w-full py-3 rounded bg-red-800 text-white font-medium'>{isAlreadyEnrolled ? 'Already Enrolled' : 'Enroll Now'}</button>
